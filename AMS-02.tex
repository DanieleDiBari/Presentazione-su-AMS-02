...
\begin{frame}
	\frametitle{TRD - Transition Radiation Detector}
	\framesubtitle{TRD support structure}
	\justifying
...
\begin{frame}
	...
	\hfill\hyperlink{TRD-SpaceQual}{\beamerbutton{more details on Space Qualification}}
\end{frame}

\begin{frame}[label=TRD-SQ_TestStruct,noframenumbering]
	\frametitle{TRD - Transition Radiation Detector}
...
\begin{frame}[label=TRD-SpaceQual,noframenumbering]
	...
	\hfill\hyperlink{TRD-SQ_TestStruct}{\beamerbutton{something on the space qualification of the TRD support structure}}
