...
\begin{frame}[label=TRK-Ladder1]
	...
	\small{The array of sensor that compound a ladder are glued on a Upilex cable and mounted on an Airex support that confers
	the mechanical stability to the module. }
	...
	\begin{columns}
		...
		\begin{column}{0.49\textwidth}\justifying
			\small{The ladder is protected from the light 
			...
			The Upilex foil is separated from the silicon sensor surface by an Airex structure.
...
%		
%		\scriptsize{\bluetextbf{Figure:}\\
%						\bluetextit{Exploded view of a ladder}}
%		\vspace*{-0.6cm}
%											
...
\begin{frame}[label=TRK-BondSchem-side,noframenumbering]
	\frametitle{Silicon Tracker}
	\framesubtitle{bonding scheme of the readout strips}
	...
	\begin{columns}
		\begin{column}{0.1\textwidth}\end{column}
		\begin{column}{0.8\textwidth}\centering
			\scriptsize{\bluetextbf{Figure:} Signal routing for the K5 design - a ladder with 12 sensors.}		
		\end{column}
		\begin{column}{0.1\textwidth}\end{column}
	\end{columns}
\end{frame}
