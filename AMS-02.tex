		...
		\begin{columns}
			...
			\begin{column}{0.325\textwidth}
				...
				\begin{center}
					...
					\hspace{0.4cm}\hyperlink{TRD-Module}{\beamerbutton{photo of a TRD module}}
				\end{center}
			\end{column}
		\end{columns}	
...
\begin{frame}[label=Supp_Struct]
	\frametitle{TRD - Transition Radiation Detector}
	\framesubtitle{the support structure of the TRD\hspace{2.35cm}\hyperlink{TRD-Mech_Struct}{\beamerbutton{more about the Mechanical Structure of the TRD}}}
	\justifying
...
\begin{frame}[label=TRD-Module,noframenumbering]
	\frametitle{TRD - Transition Radiation Detector}
	\framesubtitle{photo of a radiator and a straw module \hspace{4cm}\hyperlink{TRD-Design}{\beamerbutton{back to TRD design}}}
	%\begin{center}
		\vspace{-0.1cm}
		\includegraphics[width=0.95\paperwidth]{TRD-RadEStraws.png}
	%\end{center}
\end{frame}
...
\begin{frame}[label=TRD-SpaceQual,noframenumbering]
	...
	\hfill\hyperlink{TRD-SQ_StrawsMod}{\beamerbutton{back to the previous slide}}
