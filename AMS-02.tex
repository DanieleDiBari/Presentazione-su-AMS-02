...
\begin{frame}[label=MAGNET-Choice]
	...
	\begin{columns}
		\begin{column}{0.01\textwidth}\end{column}	
		\begin{column}{0.54\textwidth}\justifying
			\vspace*{-0.3cm}
			\begin{block}{\footnotesize{Improvement for a long duration mission}}\justifying
				\begin{columns}
				\begin{column}{0.01\textwidth}\end{column}
		...
		\begin{column}{0.43\textwidth}\centering
			\scriptsize{\bluetextbf{Magnets Comparison}}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.55\textwidth}\justifying
			...
			This is because longer cylinders, with the same diameter, have narrower angular field-of-views (reduction in acceptance).}
			...
			\begin{block}{\footnotesize{CRs yield of the two configurations}}\justifying
				...
				\begin{column}{0.01\textwidth}\end{column}
					\begin{column}{0.98\textwidth}\justifying
						...
						As an example the number of positrons collected in the PM configuration is expected to be a factor 2 to 6 
